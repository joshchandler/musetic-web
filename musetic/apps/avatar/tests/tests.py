...
from musetic.apps.avatar.conf import settings
from musetic.apps.avatar.util import get_primary_avatar, get_user_model
from musetic.apps.avatar.models import Avatar
...
class AvatarUploadTests(TestCase):
    ...
    def testImageWithoutExtension(self):
        # use with AVATAR_ALLOWED_FILE_EXTS = ('.jpg', '.jpeg', '.png')
