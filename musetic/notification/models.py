...
class Notification(models.Model):
    ...
    HTML Representation::
        ...
        commented on <a href="http://github.com/pinax/pinax">pinax/pinax</a> 2 hours ago
    ...
    target_content_type = models.ForeignKey(
        ContentType, related_name='notify_target',
    ...
    action_object_content_type = models.ForeignKey(
        ContentType, related_name='notify_action_object', blank=True, null=True)
...
# connect the signal
notify.connect(notify_handler, dispatch_uid='musetic.apps.notification.models.notification')
