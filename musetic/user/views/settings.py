...
from musetic.user.models import Profile, Settings
from musetic.user.forms import SettingsProfileForm, SettingsGeneralForm, ChangeUsernameForm, ChangeEmailForm
